...
export default function AddProductPage() {
    ...
    const [formData, setFormData] = useState({
        ...
        is_sellable: true,
        imageUrls: [] as string[],
        variants: [{ name: "預設規格", price: 0, selling_price: 0, stock: 0 }] as any[]
    });
    ...
    const handleSave = async () => {
        try {
            ...
            alert("商品新增成功");
            // Optional: close window if opened in new tab
            // window.close();
    ...
    return (
        <div className="max-w-4xl mx-auto py-8 px-4">
            <div className="flex items-center mb-6 gap-4">
                ...
                <h1 className="text-3xl font-bold text-slate-800">新增商品</h1>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 space-y-6">
                ...
                <div className="mt-8 flex justify-end gap-3 pt-4 border-t border-slate-100">
                    ...
                    <button onClick={handleSave} className="px-6 py-2.5 bg-slate-900 text-white rounded-lg hover:bg-slate-800 transition-colors">儲存商品</button>
                </div>
            </div>
        </div>
    );
